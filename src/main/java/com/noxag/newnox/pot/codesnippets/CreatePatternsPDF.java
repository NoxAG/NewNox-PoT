...
public final class CreatePatternsPDF {
    ...
    public static void main(String[] args) throws IOException {
        try (PDDocument doc = new PDDocument()) {
            ...
            // Colored pattern, i.e. the pattern content stream will set its own
            // color(s)
            try (PDPageContentStream pcs = new PDPageContentStream(doc, page)) {
                // Colored pattern, i.e. the pattern content stream will set its
                // own color(s)
                ...
                // TODO
                // there's no way to create something like a
                // PDPageContentStream,
                ...
                // for the color values that will be passed when painting the
                // fill
            ...
            doc.save("C:/Users/IBM_ADMIN/Documents/patterns.pdf");
        }
    }
}