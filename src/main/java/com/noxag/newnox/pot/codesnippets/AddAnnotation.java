package com.noxag.newnox.pot.codesnippets;
/*
...
public final class AddAnnotation {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            position.setLowerLeftX(INCH);
            position.setLowerLeftY(ph - 1.5f * INCH - 20); // down a couple of
                                                           // points
            position.setUpperRightX(INCH + textWidth);
            ...
            // Place the annotation on the page, we'll make this 1" (72 points)
            // square
            ...
            position.setLowerLeftY(ph - 3.5f * INCH - INCH); // 1" height, 3.5"
                                                             // down
            ...
            // Now add the link annotation, so the click on "Jump to page three"
            // works
            ...
            position = new PDRectangle();
            position.setLowerLeftX(INCH);
            position.setLowerLeftY(ph - 2 * INCH - 20); // down a couple of
                                                        // points
            position.setUpperRightX(INCH + textWidth);
            ...
            // do not use setPageNumber(), this is for external destinations
            // only
            dest.setPage(page3);
