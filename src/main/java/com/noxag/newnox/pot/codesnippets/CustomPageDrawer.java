...
public class CustomPageDrawer {
    public static void main(String[] args) throws IOException {
        File file = new File("C:/Users/IBM_ADMIN/Desktop/IBM/PE_2/Praxisarbeit/",
                "TINF16AI-BC-Schmidt-Tobias-PA_2.pdf");
    ...
    public static BufferedImage getBufferedImageByPDF(PDDocument doc) {
        PDFRenderer renderer = new MyPDFRenderer(doc);
        try {
    ...
    private static class MyPageDrawer extends PageDrawer {
        ...
        protected void showGlyph(Matrix textRenderingMatrix, PDFont font, int code, String unicode, Vector displacement)
                throws IOException {
            // draw glyph
            textRenderingMatrix.rotate(Math.PI / 2);
        ...
        public void showAnnotation(PDAnnotation annotation) throws IOException {
            ...
            // 35% alpha
            getGraphicsState().setNonStrokeAlphaConstant(0.1);
